...
/*   Updated: 2023/01/12 00:04:08 by gsever           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 		main->ply.angle += val * PLAYER_ROTATION_SPEED;
// 	if (main->ply.angle < 0)
// 		main->ply.angle = 360;
// 	else if (main->ply.angle > 360)
// 		main->ply.angle = 0;
// }
...
// // 	last_location_x = main->ply.pos_x;
// // 	last_location_y = main->ply.pos_y;
// // 	main->ply.pos_x -= val * (main->ply.pos_y * PLAYER_WALK_SPEED);
// // 	if (is_wall(main, main->ply.pos_x, main->ply.pos_y))
// // 		main->ply.pos_x = last_location_x;
// // 	main->ply.pos_y += val * (main->ply.pos_x * PLAYER_WALK_SPEED);
// // 	if (is_wall(main, main->ply.pos_x, main->ply.pos_y))
// // 		main->ply.pos_y = last_location_y;
// // }
...
// // 	last_location_x = main->ply.pos_x;
// // 	last_location_y = main->ply.pos_y;
// // 	main->ply.pos_x += val * (main->ply.pos_x * PLAYER_WALK_SPEED);//bu okay ama karakter nereye bakiyorsa oraya dogru ilerlemiyor
// // 	// main->ply.pos_x -= val * (PLAYER_WALKSPEED / main->box_size) * cos(main->ply.rotationAngle * (M_PI / 180));
// // 	if (is_wall(main, main->ply.pos_x, main->ply.pos_y))
// // 		main->ply.pos_x = last_location_x;
// // 	main->ply.pos_y += val * (main->ply.pos_y * PLAYER_WALK_SPEED);//bu okay ama karakter nereye bakiyorsa oraya dogru ilerlemiyor
// // 	// main->ply.pos_y -= val * (PLAYER_WALKSPEED / main->box_size) * sin(main->ply.rotationAngle * (M_PI / 180));
// // 	if (is_wall(main, main->ply.pos_x, main->ply.pos_y))
// // 		main->ply.pos_y = last_location_y;
// // }
